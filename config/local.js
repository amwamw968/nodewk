...
module.exports = {
  ...
  //ssl: {
    // ca: require('fs').readFileSync(__dirname + '/../cert/214671713870119.pem'),
    // key: require('fs').readFileSync(__dirname + '/../cert/214671713870119.key'),
    // cert: require('fs').readFileSync(__dirname + '/../cert/214671713870119.pem')
   //},
